                            ...
                            <div className="row">
                                <div className="col-md-12 d-flex align-items-end justify-content-between">
                                    ...
                                    <div className="footer-address">
                                        ...
                                        <a href="#" className="footer-address__text_color">
                                            показать на карте
                                        </a>
                                    </div>
                                    ...
                                    <div className="footer-block-subscr">
                                        <p className="footer-address__text footer-address__text_left">Подписывайтесь на новости и акции</p>
                                ...
                                <div className="container">
                                    <div className="col-12">
                                        <div className="under-footer d-flex justify-content-between align-items-center">
                                            ...
                                            <a href="https://bobo.tj/" className="under-footer__logo">
